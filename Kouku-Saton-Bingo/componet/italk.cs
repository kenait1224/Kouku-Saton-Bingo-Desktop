...
class iTalk_TabControl : TabControl
{
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        _Graphics.FillRectangle(new SolidBrush(Color.FromArgb(246, 246, 246)), new Rectangle(-5, 0, ItemSize.Height + 4, Height));
        // Draw vertical line at the end of the tab selector rectangle
        _Graphics.DrawLine(new Pen(Color.FromArgb(175, 177, 182)), ItemSize.Height - 1, 0, ItemSize.Height - 1, Height);
        ...
        for (int TabIndex = 0; TabIndex <= TabCount - 1; TabIndex++)
        {
            if (TabIndex == SelectedIndex)
            {
                ...
                _Graphics.FillRectangle(new SolidBrush(Color.FromArgb(233, 233, 226)), TabRect.X, TabRect.Y, TabRect.Width - 4, TabRect.Height + 3);
                ...
                _Graphics.FillRectangle(new SolidBrush(Color.FromArgb(120, 129, 135)), TabHighlighter);
                // Draw tab text
                _Graphics.DrawString(TabPages[TabIndex].Text, new Font(Font.FontFamily, Font.Size, FontStyle.Bold), new SolidBrush(Color.FromArgb(120, 129, 135)), new Rectangle(TabRect.Left, TabRect.Top + ItemSize.Width / 2 - (int)Font.Height / 2 - 3, TabRect.Width , TabRect.Height), new StringFormat { Alignment = StringAlignment.Center });
            ...
            {
                Rectangle TabRect = new Rectangle(new Point(GetTabRect(TabIndex).Location.X - 2, GetTabRect(TabIndex).Location.Y - 2), new Size(GetTabRect(TabIndex).Width + 3, GetTabRect(TabIndex).Height - 8));
                _Graphics.DrawString(TabPages[TabIndex].Text, new Font(Font.FontFamily, Font.Size, FontStyle.Bold), new SolidBrush(Color.FromArgb(188, 190, 194)), new Rectangle(TabRect.Left, TabRect.Top + ItemSize.Width/ 2 - (int)Font.Height / 2 -3, TabRect.Width , TabRect.Height), new StringFormat { Alignment = StringAlignment.Center });
